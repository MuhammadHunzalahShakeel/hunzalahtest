...
const ArticleCategory = () => {
  return (
    <section className="articlecategory-section">
      <div className="articlecategory-heading">
        <h1>Categories</h1>
      </div>
    <div className="articlecategory-container">
        <div className="articlecategory-column">
          <div className="articlecategory-box">
            <img src={catvector1} alt="" />
            <h2>Business Modeling and Operations Documentation</h2>
            <p className="articlecategory-para">Articles 4</p>
            <p className="articlecategory-date">12 Jan 2022</p>
          </div>
        </div>
        <div className="articlecategory-column">
          <div className="articlecategory-box">
            ...
            <p className="articlecategory-para">Articles 1</p>
            <p className="articlecategory-date">25 Oct 2021</p>
          </div>
        </div>
        <div className="articlecategory-column">
          <div className="articlecategory-box">
            ...
            <p className="articlecategory-para">Articles 9</p>
            <p className="articlecategory-date">12 Jan 2022</p>
          </div>
        </div>
        <div className="articlecategory-column">
          <div className="articlecategory-box">
            ...
            <p className="articlecategory-para">Articles 2</p>
            <p className="articlecategory-date">12 Jan 2022</p>
          </div>
        </div>
        <div className="articlecategory-column">
        ...
        <div className="articlecategory-column">
          <div className="articlecategory-box">
            ...
            <h2>Marketing</h2>
            <p className="articlecategory-para">Articles 11</p>
            <p className="articlecategory-date">25 Oct 2021</p>
          </div>
        </div>
        <div className="articlecategory-column">
          <div className="articlecategory-box">
            ...
            <p className="articlecategory-para">Articles 3</p>
            <p className="articlecategory-date">25 Oct 2021</p>
          </div>
        </div>
        <div className="articlecategory-column">
        ...
        <div className="articlecategory-column">
          <div className="articlecategory-box">
            ...
            <p className="articlecategory-para">Starts at</p>
            <p className="articlecategory-date">12 Jan 2022</p>
          </div>
        </div>
      </div>
